          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/50">
              <div>
                ...
                <p className="text-xs text-gray-500">Quand un quiz de votre catégorie est ajouté.</p>
              </div>
             ...
             <div className="flex items-center justify-between p-3 rounded-lg bg-white/50">
              <div>
                ...
                <p className="text-xs text-gray-500">Recevoir une notification après un quiz.</p>
              </div>
             ...
             <div className="flex items-center justify-between p-3 rounded-lg bg-white/50">
              <div>
                ...
                <p className="text-xs text-gray-500">Conseils et actualités sur les concours.</p>
              </div>
          ...
          <Card className="glassmorphism shadow-xl">
           ...
           <Card className="glassmorphism shadow-xl">
            ...
            <CardContent>
               <div className="flex items-center justify-between p-3 rounded-lg bg-white/50">
                <div>
                  <Label htmlFor="dark-mode" className="font-semibold text-sm">Mode Sombre</Label>
                </div>
                <Switch id="dark-mode" />
              </div>
            </CardContent>
